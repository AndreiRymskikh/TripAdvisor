    ...
    public class CruisesClient : BaseClient
    {
        public async Task<int> GetDestinationIdAsync(string destinationName)
        {
            ...
            return destination?.DestinationId
                ?? throw new ApplicationException($"Destination '{destinationName}' not found in the API response.");
        }
        ...
        public async Task<List<CruiseDetails>> GetCruisesByDestinationAsync(int destinationId)
        {
            ...
            request.AddQueryParameter("order", "popularity");
            request.AddQueryParameter("currencyCode", "USD");
            ...
            {
                throw new ApplicationException($"No cruise data found for destinationId: {destinationId}");
            }
